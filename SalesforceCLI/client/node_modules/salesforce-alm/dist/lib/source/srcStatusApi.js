...
class SrcStatusApi extends kit_1.AsyncCreatable {
    ...
    populateServerChanges(options) {
        ...
        return srcDevUtil
            ...
            return this.force.toolingFind(this.scratchOrg, 'SourceMember', { [sourceUtil_1.getRevisionFieldName()]: { $gt: maxRevision } }, [
                'MemberType',
                'MemberName',
                'IsNameObsolete'
            ]);
                ...
                if (!util.isNullOrUndefined(localAggregateSourceElement)) {
                    ...
                    if (workspaceElements.length > 0) {
                        return workspaceElements.filter(workspaceElement => {
                            ...
                            return workspaceElementMetadataType.sourceMemberFullNameCorrespondsWithWorkspaceFullName(sourceMember.MemberName, workspaceElement.getFullName()) || workspaceElementMetadataType.sourceMemberFullNameCorrespondsWithWorkspaceFullName(`${sourceMember.MemberType}s`, //for nonDecomposedTypesWithChildrenMetadataTypes we need to check their type
