    ...
    async run() {
        ...
        if (this.flags.type === orgTypes_1.OrgTypes.Sandbox) {
            ...
            sandboxOrg.on(sandboxConstants_1.SandboxEventNames.EVENT_RESULT, results => {
                ...
                if (results.sandboxRes && results.sandboxRes.authUserName) {
                    ...
                    if (this.flags.setdefaultusername) {
                        ...
                        globalConfig.write().then(result => this.logger.debug('Set defaultUsername: %s result: %s', this.flags.setdefaultusername, result));
                    }
                }
            });
            ...
            if (srcSandboxName) {
                ...
                throw core_1.SfdxError.create(new core_1.SfdxErrorConfig('salesforce-alm', 'org_clone', 'missingSourceSandboxName', [sandboxConstants_1.SANDBOXDEF_SRC_SANDBOXNAME])
            ...
            throw core_1.SfdxError.create(new core_1.SfdxErrorConfig('salesforce-alm', 'org_clone', 'commandOrganizationTypeNotSupport', [orgTypes_1.OrgTypes.Sandbox])
