...
class App extends Generator {
    ...
    writing() {
        ...
        switch (this.type) {
            ...
            case 'plugin':
            case 'sfdx-plugin':
                this.pjson.oclif = Object.assign({ commands: `./${this.ts ? 'lib' : 'src'}/commands`, 
    ...
    install() {
        ...
        switch (this.type) {
            ...
            case 'plugin':
                ...
                break;
            case 'sfdx-plugin':
                dependencies.push('@oclif/command@^1', '@oclif/config@^1', '@oclif/errors@^1', '@salesforce/command@^1.4.1', '@salesforce/core@^1.3.2');
                devDependencies.push('@oclif/dev-cli@^1', '@oclif/plugin-help@^2', 'globby@^8', '@salesforce/dev-config@1.4.1');
                break;
            case 'multi':
                dependencies.push('@oclif/config@^1', '@oclif/command@^1', '@oclif/plugin-help@^2');
        ...
        if (this.ts) {
            ...
            devDependencies.push('@types/node@^10', 'ts-node@^8');
            if (this.mocha) {
                devDependencies.push('@types/chai@^4', '@types/mocha@^5');
            }
            if (this.tslint) {
                devDependencies.push('tslint@^5');
            }
        }
        if (this.eslint) {
    ...
    _writeSfdxPlugin() {
        ...
        if (!fs.existsSync('src/commands')) {
            this.fs.copyTpl(this.templatePath(`src/sfdxCommand.${this._ext}.ejs`), this.destinationPath(`src/commands/${topic}/${sfdxExampleCommand}.${this._ext}`), Object.assign({}, opts, { pluginName: this.pjson.name, commandName: sfdxExampleCommand, topicName: topic }));
        }
        this.fs.copyTpl(this.templatePath('sfdxPlugin/src/index.ts'), this.destinationPath('src/index.ts'), opts);
        if (this.mocha && !fs.existsSync('test')) {
            this.fs.copyTpl(this.templatePath(`sfdxPlugin/test/command.test.${this._ext}.ejs`), this.destinationPath(`test/commands/${topic}/${sfdxExampleCommand}.test.${this._ext}`), Object.assign({}, opts, { name: sfdxExampleCommand, topic }));
        }
