...
exports.apiLimits = function (limits) {
    logApi.table(limits, {
        columns: [
...
let prepNullValues = function (records) {
...
let bulkStatus = function (summary, results, batchNum, isJob) {
...
let recordHelper = function (indent, rec) {
