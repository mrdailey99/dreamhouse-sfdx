...
const messages = {
    default: {
        en_US: {
            ...
            metadataTypeNotSupported: 'No source tracking support for type: %s. For details, visit ' +
                'https://developer.salesforce.com/docs/metadata-coverage and select your API version. Skipping...'
        }
    },
    IndexErrorProcessor: {
        en_US: {
