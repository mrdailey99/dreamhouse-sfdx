...
class SandboxOrg extends events_1.EventEmitter {
    ...
    getMaxPollingRetries() {
        return this.wait ? this.wait.seconds / sandboxConstants_1.SandboxConstants.DEFAULT_POLL_INTERVAL.seconds : sandboxConstants_1.SandboxConstants.DEFAULT_MAX_RETRIES;
    }
    ...
    async writeAuthFile(sandboxProcessObj, sandboxRes) {
        ...
        if (sandboxRes.authUserName) {
            ...
            const authInfo = await core_1.AuthInfo.create({ username: sandboxRes.authUserName, oauth2Options });
            await authInfo.save();
